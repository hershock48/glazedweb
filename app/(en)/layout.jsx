...
export const metadata = {
  ...
  title: "Websites & Connected Business Systems | glazedweb",
  description: `Custom websites, ordering, POS integrations, and owner tools for independent businesses. Your technology partner in Marshall, Michigan.`,
  ...
  openGraph: {
    title: "Websites & Connected Business Systems | glazedweb",
    description: `Beautiful customer experiences and business tools that work together. Websites, Jelly ordering, integrations, and custom solutions by Glazed Web.`,
    type: "website",
...
const localBusinessSchema = {
  ...
  name: "glazedweb",
  description:
    "Technology partner for independent businesses. Custom websites, online ordering, POS integrations, admin panels, and business tools built in Marshall, Michigan.",
  url: "https://www.glazedweb.com",
  email: CONTACT_EMAIL,
