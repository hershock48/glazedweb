...
**Glazed Web Client Agreement v1.0**, in three places that must change together:

1. `contracts/Glazed_Web_Client_Agreement_v1.docx`, the master, generated by
...
3. `public/glazed-web-agreement-v1.pdf`, the download linked from that page.
