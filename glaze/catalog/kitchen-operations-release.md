...
Printer acknowledgement and owner reconciliation now use durable job tokens, atomic acceptance/history and saved review results; see [printer release](printer-release.md). Physical hardware and hosted concurrent connections remain unverified.
