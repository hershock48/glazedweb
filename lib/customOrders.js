...
export const CUSTOM_ORDERS = {
   ...
   * Numbers are the letter's: $3,500 to build, $99 a month. The paper draft
  ...
  migas: {
    ...
    buildFeePaid: false,
    monthly: 99,
    /** House guess for a $99 order (Chism's $50 order carries one hour,
     *  Anchor's $150 carries two). The paper draft left it bracketed. */
    editAllowance: "1 hour per month",
    hourlyRate: 125,
    monthlyCovers:
