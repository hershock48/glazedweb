...
export const CUSTOM_ORDERS = {
  ...
  anchor: {
    ...
    exhibit: "Exhibit A: Anchor Insurance, prepared 2026-09-17",
    /** A spec build, live at anchor.glazedweb.com/demo, not on her domain. */
    live: false,
    pitchUrl: "https://anchor.glazedweb.com/",

    /** The proposal's numbers. $3,500 and $150 from August 2026 until
     *  September 16, 2026, when Kevin repriced to $2,000 and $100; the
     *  proposal (anchor/public/pitch) and the paper twin in contracts-private
     *  carry the same numbers and move together. */
    buildFee: 2000,
    buildFeePaid: false,
    monthly: 100,
    editAllowance: "2 hours per month",
    hourlyRate: 125,
    monthlyCovers:
      "Hosting, SSL, security updates, backups, domain renewal where we hold it, and the workroom; there is no separate platform, per-lead or per-customer charge.",
    editExamples:
    ...
    scope: [
      ...
      "The workroom, the agency’s own tool behind a passcode: the leads queue, worked through new, called, quoted and won or lost with the agency’s own notes on each, and the site facts editor.",
    ...
    /* EXHIBIT A HAD A PART 3, the online payment service, and it is gone as of
       17 September 2026. The client does not want the site taking money for
       now. It was the first and only use of the studio-collects-a-fee rail in
       any agreement, so it is worth knowing where it went rather than
       rediscovering it: seven clauses covering her own Stripe account, the
       flat $0.99 paid by her customer and collected by glazedweb as the
       payment technology provider, the per-carrier authority to collect
       premium, the book and the card data, the messages to customers,
       availability, and her part. The full text is in this file's git history
       and the service it described is on the anchor repo's branch
       archive/payments-2026-09. If payments come back, part 3 comes back with
       them and goes to an attorney first, which is what it always needed. */

    /** Three real screens, sample data, rendered from the build. Kevin: "just
     *  so they can see what we're talking about."
     *
     *  RE-SHOT 2026-09-17. Two of the three were the book and a customer's
     *  bill, and both screens left with the payment service; the third showed
     *  a tab row that no longer exists. The leads queue and the quote form
     *  replace them, which is also the honest order of what this site does for
     *  her. The names and numbers in the queue are invented. */
    figures: [
      {
        src: "/agreement/anchor/workroom-leads.png",
        width: 1100,
        height: 760,
        alt: "The workroom’s leads queue: five quote requests, newest first, each with the coverage asked for, the ZIP and a call button, above filters for new, called, quoted, won and lost.",
        caption: "The workroom: every quote request, newest first, with a call button and your own notes on each.",
      },
      {
        src: "/agreement/anchor/quote-phone.png",
        width: 390,
        height: 1240,
        alt: "The quote form on a phone: coverage, name, phone, ZIP, an optional email, the call-and-text consent box and a Continue button.",
        caption: "What your customer does: four fields on a phone, and it is in your queue before they put it down.",
      },
      {
    ...
    project: {
      ...
      needs: [
        ...
        {
          id: "carriers",
          ask: "Your carrier appointments, and the marketing rules each one puts on its logo.",
          why: "The carrier wall is the biggest trust element on an insurance site and it is the one thing we cannot find out for you. Several carriers restrict how their mark may be used and a few review marketing before it publishes.",
          done: false,
        },
        {
          id: "story",
      ...
      steps: [
        ...
        {
          title: "Forms pointed at your real inbox.",
          detail: "Quote requests, tested by sending real ones through, not by trusting that they work.",
        },
        {
          title: "The domain moves.",
      ...
      freebies: [
        ...
        },
        {
          ...
          text: "The site asks happy customers for a Google review on the homepage and the contact page, the moment your review link exists. Getting your first twenty reviews will do more for you than half of this website.",
        },
      ],
      links: [
        { label: "The site", href: "https://anchor.glazedweb.com/demo", note: "Where it lives until it is on your domain." },
        { label: "The workroom", href: "https://anchor.glazedweb.com/workroom", note: "Leads and site facts. Passcode sent separately." },
      ...
      tryIt: [
        {
          lead: "Walk a quote.",
          text: "Fill in the quote form as a customer would, on your phone. It lands in the workroom’s Leads tab within a minute, with your notes box beside it.",
          href: "https://anchor.glazedweb.com/demo/quote",
        },
        {
          lead: "Work the lead you just made.",
          text: "Open it, move it from new to called to quoted, and write yourself a note. The filters at the top count what is still open, which is the only number on the screen that matters on a Monday.",
          href: "https://anchor.glazedweb.com/workroom",
        },
        {
          lead: "Change a fact.",
        ...
        {
          lead: "Price your own PIP.",
          text: "The Michigan PIP tool on the site is the page she liked most. Put your own numbers in it and see what each level costs, which is the conversation you have on the phone twenty times a month.",
          href: "https://anchor.glazedweb.com/demo/tools/michigan-pip",
        },
      ],
      monthlyIs: [
        ...
        "Hosting, security, backups, the domain and the workroom.",
      ],
    },
  },
   ...
   * Numbers: $1,000 to build (Kevin, 2026-09-16, down from the letter's
   * $3,500; the letter was revised the same day), $150 a month (Kevin,
   * 2026-09-10, up from the letter's $99). The paper draft in
   * contracts-private (v1.1, regenerated 2026-09-16) carries the same two
   * numbers; its bracketed fields are the TODOs below.
   */
  migas: {
    slug: "migas",
    client: "MI Gas",
    ...
    town: "Michigan",
    domain: "mi-gas.net",
    exhibit: "Exhibit A: MI Gas, prepared 2026-09-16",
    /** A spec build, live at migas.glazedweb.com/demo; mi-gas.net still points at Squarespace. */
    live: false,
    pitchUrl: "https://migas.glazedweb.com/",

    /** $1,000 is Kevin's number of 2026-09-16, down from the letter's
     *  $3,500, which was set before the call and held after the call added
     *  co-management, the editor, the feed and the Patreon section. The
     *  letter's revision line records the drop. */
    buildFee: 1000,
    buildFeePaid: false,
    monthly: 150,
    ...
    project: {
      ...
      freebies: [
        {
          lead: "The work added after the call, and the price went down.",
          text: "Co-management with its application and one-pager, the availability editor, the calendar feed and the Patreon section all arrived after the first price was set, and the build fee still came down, from $3,500 to $1,000. The extra work is ours to stand behind, not yours to absorb.",
        },
      ],
      links: [
  ...
  mikesplace: {
    ...
    /** $3,000 build, $150 a month (Kevin, 2026-09-13). Above the Baker's Dozen
     *  menu price because the ordering system and the workroom are in it. */
    buildFee: 3000,
    buildFeePaid: false,
    monthly: 150,
    editAllowance: "2 hours per month",
    ...
    scope: [
      ...
      "Online ordering, built into the site and switched off: the order page, a passcode-protected kitchen screen behind the bar with a one-tap accept and an 86 board, and a pause button. It is an add-on, priced and described in part 3, and it stays off until you take it.",
    ...
    notIncluded:
      "online ordering, unless the add-on in part 3 is taken; photography; copywriting beyond the pages listed; online card processing, which runs on your own processor account at that processor’s rates; point of sale or in-store hardware; delivery of any kind; printed materials; and a second website on any other platform.",
    ...
    moreTerms: [
      {
        ...
        summary: "how online ordering and its fee work",
        intro:
          "Online ordering is an add-on to the site: a one-time $500, due when you ask for it to be switched on, whether that is launch day or later. Once on, the site takes pickup orders paid in advance by card on a payment processor account in your name, or paid at the bar. These terms apply to that service from the day it is switched on and are part of the agreement.",
        items: [
          {
    ...
    project: {
      ...
      steps: [
        ...
        {
          title: "Ordering, when you want it.",
          detail: "An add-on, taken separately and not on launch day. Pay-at-the-bar first if you like, card payment once your processor is connected and you have watched a test order land on the kitchen screen.",
        },
      ],
      freebies: [
        {
      ...
      links: [
        ...
        { label: "The kitchen screen", href: "https://mikesplace.glazedweb.com/demo/kitchen", note: "The board behind the bar. The demo PIN is your street number." },
        { label: "The workroom", href: "https://mikesplace.glazedweb.com/demo/workroom", note: "What’s on and the menu. The passcode comes by phone." },
      ],
      /**
       * The hands-on list (glaze/launch-page.md, section 6). Every item is
       * real on the deployment and leaves a trace the bar can find: since
       * 2026-09-11 the demo runs on Postgres with the ordering window held
       * open and the workroom passcode set. Prices are still samples, so
       * nothing here quotes one.
       */
      tryIt: [
        {
          lead: "Place an order.",
          text: "Pick anything on the order page, choose pay at the bar, and put it through. Nothing is charged. You will get an order number and a pickup time.",
          href: "https://mikesplace.glazedweb.com/demo/order",
        },
        {
          lead: "Watch it land behind the bar.",
          text: "Open the kitchen screen, type your street number as the PIN, and the ticket you just placed is there, ringing until somebody taps Accept.",
          href: "https://mikesplace.glazedweb.com/demo/kitchen",
        },
        {
          lead: "86 something.",
          text: "On the same screen, tap Wings under the 86 board, then reload the order page. Wings reads sold out tonight and cannot be added. Tap it again to bring them back.",
          href: "https://mikesplace.glazedweb.com/demo/order",
        },
        {
          lead: "Post tonight’s special.",
          text: "In the workroom, New post: a name, a date, a time, a line of detail. Save, and it is on the What’s On page and the homepage within seconds.",
          href: "https://mikesplace.glazedweb.com/demo/workroom",
        },
        {
          lead: "Change a price.",
          text: "Workroom, Menu tab: type a new number on any item and save. The menu page, the order page and the next kitchen ticket all show it together.",
          href: "https://mikesplace.glazedweb.com/demo/menu",
        },
      ],
      monthlyIs: [
