...
export const CUSTOM_ORDERS = {
  ...
  copperac: {
    ...
    scope: [
      ...
      "The Board: live Detroit scores and tonight’s games for the Tigers, Lions, Pistons and Red Wings on the homepage, read from ESPN, with a Detroit news line under it.",
