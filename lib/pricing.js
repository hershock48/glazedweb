...
export const PRICING = {
  us: {
    // September 16, 2026: new-inquiry starting prices approved by Kevin.
    // Website work is secondary to integrated systems. Historical client
    // agreements and quotes in customOrders.js keep their agreed numbers.
    original: { build: 1250, market: 1500, monthly: 99 },
    dozen: { build: 3000, market: 3900, monthly: 150 },
    systems: { build: 5000 },
  },
  do: {
